...
sidebar: sidebar 
keywords:  
summary: 이 섹션에서는 데이터 스토리지 용량, 가용성 및 보호 문제의 해결을 위해 OnCommand Unified Manager가 제공하는 2개의 사용자 인터페이스에 대해 설명합니다. UI 두 개는 Unified Manager 웹 UI와 유지보수 콘솔입니다. 
---
...
[role="lead"]
이 섹션에서는 데이터 스토리지 용량, 가용성 및 보호 문제의 해결을 위해 OnCommand Unified Manager가 제공하는 2개의 사용자 인터페이스에 대해 설명합니다. UI 두 개는 Unified Manager 웹 UI와 유지보수 콘솔입니다.
